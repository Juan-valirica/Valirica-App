...
$preheader = "Se ha registrado una nueva denuncia en tu canal. Código: {$reference_code}";
...
<p style="margin:0 0 24px;font-size:15px;color:#7a7977;font-family:Georgia,serif;">
  Hola <?= htmlspecialchars($nombre_responsable) ?>, se ha registrado una nueva denuncia en el canal de tu empresa.
</p>
...
<table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="margin:0 0 28px;">
  <tr>
    <td style="background-color:#f7f6f4;border:1px solid #e8e6e3;border-radius:12px;padding:20px 24px;">
      <p style="margin:0 0 6px;font-size:13px;color:#9a9896;font-family:Georgia,serif;text-transform:uppercase;letter-spacing:0.8px;">
      ...
      <p style="margin:0 0 4px;font-size:14px;color:#3d3c3b;font-family:Georgia,serif;">
        📋 Tipo: <strong><?= htmlspecialchars($type_label) ?></strong>
      </p>
      <p style="margin:0;font-size:14px;color:#3d3c3b;font-family:Georgia,serif;">
        <?= $flag ?> País: <strong><?= $country === 'CO' ? 'Colombia' : 'España' ?></strong>
      </p>
    </td>
  </tr>
</table>

<p style="margin:0 0 24px;font-size:15px;color:#3d3c3b;line-height:1.7;font-family:Georgia,serif;">
  Accede al panel para revisar los detalles, gestionar el expediente y cumplir con los plazos legales.
</p>
...
<p style="margin:0;font-size:13px;color:#9a9896;line-height:1.6;font-family:Georgia,serif;">
  Este aviso es confidencial y está dirigido exclusivamente al responsable del canal de denuncias.<br>
  No compartas este correo ni el código de referencia con terceros.
</p>
<?php
